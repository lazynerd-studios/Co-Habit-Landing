  ...
  return (
    <section className=''>
      ...
      >
        ...
        {/* listings */}
        <div className="bg-white flex py-8 px-4  laptop:mx-[8rem]">
          ...
          {/* all property */}
          <div className="laptop:px-8 px-0  laptop: mx- mx-auto">
            ...
            <div class="grid grid-cols-1 gap-6 laptop:grid-cols-3 tablet:grid-cols-2 laptop:gap-8">
              {/* 01 */}
